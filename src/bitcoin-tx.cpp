...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SeventeenSeventySix seventeenseventysix-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  seventeenseventysix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seventeenseventysix transaction") + "\n" +
              "  seventeenseventysix-tx [options] -create [commands]   " + _("Create hex-encoded seventeenseventysix transaction") + "\n" +
              "\n";
