...
bool CWalletDB::WriteCryptedZKey(const libseventeenseventysix::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libseventeenseventysix::PaymentAddress& addr, const libseventeenseventysix::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libseventeenseventysix::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 vkValue;
            ssValue >> vkValue;
            libseventeenseventysix::ViewingKey vk(vkValue);
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("seventeenseventysix-wallet");
