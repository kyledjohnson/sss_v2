...
#ifndef SEVENTEENSEVENTYSIX_AMQP_AMQPABSTRACTNOTIFIER_H
#define SEVENTEENSEVENTYSIX_AMQP_AMQPABSTRACTNOTIFIER_H
...
#endif // SEVENTEENSEVENTYSIX_AMQP_AMQPABSTRACTNOTIFIER_H
