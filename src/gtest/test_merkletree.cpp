...
template<>
void expect_deser_same(const libseventeenseventysix::MerklePath& expected)
{
...
TEST(merkletree, emptyroots) {
    ...
    libseventeenseventysix::EmptyMerkleRoots<64, libseventeenseventysix::SHA256Compress> emptyroots;
