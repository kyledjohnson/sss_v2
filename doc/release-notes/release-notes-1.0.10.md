...
ECDSA signatures inside SeventeenSeventySix transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to SeventeenSeventySix.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in seventeenseventysix-gtest
