...
Jack Grigg (14):
      ...
      Convert SeventeenSeventySix versions to Debian format
      ...
      Implement automatic shutdown of deprecated SeventeenSeventySix versions
...
Jay Graber (2):
      Change help text examples to use SeventeenSeventySix addresses
...
Nathan Wilcox (39):
      ...
      Add all of the seventeenseventysix release tags in my current repo as positive test vector.
      ...
      Reuse seventeenseventysix_rpc.
      Do not use `-rpcwait` on all `seventeenseventysix_rpc` invocations, only block when starting seventeenseventysixd.
...
emilrus (1):
      Replace bitcoind with seventeenseventysixd
