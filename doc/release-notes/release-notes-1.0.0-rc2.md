...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libseventeenseventysixconsensus
      Rename bitcoin-tx to seventeenseventysix-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add seventeenseventysix dev keys
      Rm bips.md
      Update files.md for seventeenseventysix
