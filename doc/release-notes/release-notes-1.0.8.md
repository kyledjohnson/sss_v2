...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to seventeenseventysixd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for seventeenseventysixd -help.
...
Jack Grigg (25):
      ...
      Add libevent to seventeenseventysix-gtest
...
Jay Graber (5):
      ...
      Add security warning to seventeenseventysix-cli --help and --version message output
      Add security warning to seventeenseventysixd metrics display
...
Sean Bowe (2):
      Introduce librustseventeenseventysix and Rust to depends system.
