...
Alfie John (1):
      Rename libzerocash to libseventeenseventysix
...
Jack Grigg (21):
      ...
      Add SeventeenSeventySix revision to version strings
      Bitcoin -> SeventeenSeventySix in version and help text
      Add SeventeenSeventySix Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-seventeenseventysix`` correctly runs the ``seventeenseventysix-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the SeventeenSeventySix build.
