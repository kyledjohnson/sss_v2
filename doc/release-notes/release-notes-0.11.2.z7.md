...
bitcartel (15):
      ...
      Update URL for seventeenseventysix alert IDs.
      ...
      Update tor.md for SeventeenSeventySix
...
Taylor Hornby (17):
      ...
      Rename zerocash to seventeenseventysix in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/seventeenseventysix in Makefile.am
      Rename zerocash_packages to seventeenseventysix_packages in packages.mk
