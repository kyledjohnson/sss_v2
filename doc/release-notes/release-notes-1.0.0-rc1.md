...
Jay Graber (17):
      ...
      Refer to SeventeenSeventySix wiki in INSTALL
      Rm bitcoin logo
      Rm build-unix.md, to keep single copy of build instructions for SeventeenSeventySix on github wiki
      Rm Bitcoin-specific documentation
      Add note that document is not updated for SeventeenSeventySix to translation policy
      Rm doc for disabled REST interface
      Change alpha to beta testnet, add seventeenseventysix hidden service
      Improve documentation on connecting to seventeenseventysix hidden server
      Improve documentation on connecting to seventeenseventysix hidden server
      Update tor.md
...
Kevin Gallagher (24):
      ...
      Adds seventeenseventysix/SeventeenSeventySix.h to LIBSEVENTEENSEVENTYSIX sources
      Adds seventeenseventysix/Proof.hpp to LIBSEVENTEENSEVENTYSIX_H
      Add alertkeys.h to libbitcoin_server_a_SOURCES
      Adds files in src/seventeenseventysix/circuit to libseventeenseventysix_a_SOURCES
      Adds zcbenchmarks.h to libbitcoin_wallet_a_SOURCES
      Adds json_test_vectors.h to seventeenseventysix_gtest_SOURCES
      Adds additional licenses to Debian copyright file
      Updates SeventeenSeventySix Core developers -> SeventeenSeventySix developers
...
Simon (11):
      ...
      Reorder gtests in seventeenseventysix-gtest.
