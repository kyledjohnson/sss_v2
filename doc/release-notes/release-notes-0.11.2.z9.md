...
Jack Grigg (11):
      ...
      Update Equihash hash generation to match the SeventeenSeventySix spec.
...
Taylor Hornby (5):
      ...
      Add -fwrapv -fno-strict-aliasing; fix libseventeenseventysix flags.
...
Gaurav Rana (1):
      Update seventeenseventysix-cli stop message.
