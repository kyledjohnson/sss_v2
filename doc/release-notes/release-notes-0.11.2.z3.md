...
Nathan Wilcox (4):
      ...
      Add a seventeenseventysix-gtest binary to our build with a single tautological test.
      Add coverage support scoped to only the seventeenseventysix-gtest run; invoke with make seventeenseventysix-cov; make cov is a superset.
...
Sean Bowe (49):
      ...
      Move incremental merkle tree tests to seventeenseventysix-gtest.
      ...
      Small nit fixes
      Run `seventeenseventysix-gtest` in `make check` and fix performance tests.
      ...
      Introduce new `libseventeenseventysix` SeventeenSeventySix protocol API and crypto constructions surrounding the zkSNARK circuit.
      ...
      libseventeenseventysix: Add tests for API
      Remove scriptPubKey/scriptSig from CPourTx, and add randomSeed.
      Transplant of libseventeenseventysix.
      ...
      Rename SEVENTEENSEVENTYSIX_ constants to ZC_.
...
Taylor Hornby (7):
      ...
      Fix RPC tests
      Rename bitcoin.conf and bitcoind.pid to seventeenseventysix.conf and seventeenseventysixd.pid in qa/ and src/
