...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "SeventeenSeventySix" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pseventeenseventysixParams with private member variable
      Revert "Reduce use of global pseventeenseventysixParams with private member variable"
      Replace seventeenseventysixParams_ with global.
      ...
      Use seventeenseventysix constants
      Fix formatting
      Add assert
