...
Jack Grigg (33):
      ...
      Migrate SeventeenSeventySix-specific code to UniValue
      ...
      Update UniValue includes in SeventeenSeventySix-specific code
      UniValue::getValues const reference
      Get rid of fPlus argument to FormatMoney in SeventeenSeventySix-specific code
