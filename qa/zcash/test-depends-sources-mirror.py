...
# contains all of the packages required to build this version of SeventeenSeventySix.
#
# This script assumes you've just built SeventeenSeventySix, and that as a result of that
