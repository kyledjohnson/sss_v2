...
## Sums commits made by contributors in each SeventeenSeventySix release note in ./doc/release-notes and writes to authors.md
def document_authors():
    ...
    with open(authors_file, 'w') as f:
        f.write('SeventeenSeventySix Contributors\n==================\n\n')
        total_contrib = {}
